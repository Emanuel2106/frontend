...
export default function FormPersona(props) {
  ...
  const handleSubmit = (event) => {
    ...
    const validatePayload = (data) => {
      if (!data.nombre || !data.tipoIdentificacion || !data.identificacion || !data.direccion) {
    ...
    const url = `${SiteProps.urlbase}/persona`;
        ...
        <DialogContent>
          ...
          <FormControl fullWidth margin="normal">
            ...
            <Select
              ...
              id="genero"
              name="genero"
              defaultValue={props.selectedRow.genero ? "female" : "male"}
              fullWidth
            >
